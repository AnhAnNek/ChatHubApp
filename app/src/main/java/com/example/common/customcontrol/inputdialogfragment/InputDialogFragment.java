...
/**
 * Lớp InputDialogFragment hiển thị một hộp thoại input với các tùy chọn có thể cấu hình.
 *
 * Tác giả: Trần Văn An
 */
public class InputDialogFragment extends AppCompatDialogFragment {
     ...
     *
     * @param view Root view của hộp thoại.
     *
     * Tác giả: Trần Văn An
     */
    ...
    /**
     * Thiết lập sự kiện cho các button của hộp thoại.
     *
     * Tác giả: Trần Văn An
     */
    ...
    public void onStart() {
        ...
        // Đặt hộp thoại có thể hủy bỏ hay không dựa trên model
    ...
    public void onDismiss(@NonNull DialogInterface dialog) {
        ...
        // Thông báo cho dismiss listener nếu nó được thiết lập
